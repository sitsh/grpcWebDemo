...
goog.exportSymbol('helloworld.HelloReply', null, proto);
goog.exportSymbol('helloworld.HelloRequest', null, proto);
goog.exportSymbol('helloworld.RepeatHelloRequest', null, proto);
/**
 ...
 */
proto.helloworld.HelloRequest.fromObject = function(obj) {
  var msg = new proto.helloworld.HelloRequest();
  goog.isDef(obj.name) && jspb.Message.setField(msg, 1, obj.name);
  return msg;
};
 ...
 *     `goog.isDef(obj.<fieldName>)` lookups.
 */
proto.helloworld.RepeatHelloRequest.fromObject = function(obj) {
  var msg = new proto.helloworld.RepeatHelloRequest();
  goog.isDef(obj.name) && jspb.Message.setField(msg, 1, obj.name);
  goog.isDef(obj.count) && jspb.Message.setField(msg, 2, obj.count);
  return msg;
};
 ...
 *     `goog.isDef(obj.<fieldName>)` lookups.
 */
proto.helloworld.HelloReply.fromObject = function(obj) {
